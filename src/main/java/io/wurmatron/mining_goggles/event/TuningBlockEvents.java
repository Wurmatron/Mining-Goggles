                ...
                if (!InteractionHandler.getStackInSlot(0).isEmpty()) {
                    ...
                    if (!tunedTo.isEmpty()) { // Is Attuned
                        if (names.contains(tunedTo)) {
                            InteractionHandler.setStackInSlot(0, incrementTuningFork(InteractionHandler.getStackInSlot(0)));
                        ...
                        InteractionHandler.getStackInSlot(0).getTag().putString("type", bestFit);
                    }
                }
            }
        }
