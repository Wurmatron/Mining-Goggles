...
public class ScreenMiningGoggles_2 extends AbstractContainerScreen<ContainerMiningGoggles_2> {
    ...
    protected void renderLabels(PoseStack PoseStack, int mouseX, int mouseY) {
        ...
        font.draw(PoseStack, new TranslatableComponent("stat.max_range.name").append(
                        " " + ItemMiningGogglesUpgraded.getMaxRange(playerInv.armor.get(3))), 107, 68,
                Color.BLACK.getRGB());
        font.draw(PoseStack, new TranslatableComponent("stat.optimal_range.name").append(
                " " + (int) ((double) ItemMiningGogglesUpgraded.getMaxRange(playerInv.armor.get(3))
