...
public class ContainerMiningGoggles_2 extends AbstractContainerMenu {
    ...
    private ContainerMiningGoggles_2(int windowId, Inventory playerInv,
        ...
        super(ContainerRegistry.containerTypeGoggles_2.get(), windowId);
    ...
    public static ContainerMiningGoggles_2 createContainerServerSide(int windowID,
                                                                     Inventory Inventory, ItemStackHandlerGoggles_2 goggleContents,
                                                                     ItemStack bag) {
    ...
    public static ContainerMiningGoggles_2 createContainerClientSide(int windowID,
        ...
        try {
            ...
            return new ContainerMiningGoggles_2(windowID, Inventory, itemStackHandler,
                    ItemStack.EMPTY);
